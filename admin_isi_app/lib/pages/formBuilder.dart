...
class _FormBuilderState extends State<FormBuilder> {
  ...
  TextEditingController formTitleController =
              ...
              onPressed: () async {
                ...
                if (newOption != null && newOption.isNotEmpty) {
                  setState(() {
                    ...
                    optionControllers
                        .add(TextEditingController(text: newOption));
                  });
                }
              },
              icon: Icon(Icons.add),
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              onPressed: () {
                setState(() {
                  fieldTitles[fieldTypes.indexWhere((element) => element['name'] == fieldType)] =
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            TextField(
              // Text field for entering form title
                                ...
                                children: [
                                  ...
                                  IconButton(
                                    ...
                                    onPressed: () {
                                      editTitle(
                                          field['name'],
                                          fieldTitles[fieldTypes.indexWhere(
                                                  (element) =>
                                              element['name'] ==
                                                  field['name'])] ??
                                              '');
            ...
            ElevatedButton(
              onPressed: () {
                if (selectedFieldType != null) {
                  ...
                  // Show error message or snackbar to select a field type
                }
              },
              style: ElevatedButton.styleFrom(
                backgroundColor: Colors.blue, // Set button background color to blue
  ...
  void saveFormDataToFirestore() async {
    try {
      ...
      Map<String, dynamic> formData = {
        'titleForm': formTitleController.text, // Add form title to the data to be saved
        'fields': formFields.map((field) {
          Map<String, dynamic> fieldData = {
            'name': field['name'],
            'title': fieldTitles[fieldTypes.indexWhere((element) =>
      ...
      // Show snackbar after successful form data save
