...
class FirebaseApi {
  ...
  Future<void> _showNotification(String title, String body, int notificationId) async {
  ...
  Future<void> _sendNotification(Map<String, dynamic> postData, int notificationId) async {
    _showNotification(
  ...
  Future<List<String>> _fetchSubscribedStudents(List<String> postCategories) async {
